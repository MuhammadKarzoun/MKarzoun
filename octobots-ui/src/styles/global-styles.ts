...
.bs-tooltip-auto[x-placement^="right"] .arrow::before {
  border-inline-end-color: ${colors.colorWhite};
}

.bs-tooltip-left .arrow::before,
.bs-tooltip-auto[x-placement^="left"] .arrow::before {
	border-inline-start-color: ${colors.colorWhite};
}
...
.bs-popover-right>.arrow, .bs-popover-auto[x-placement^="right"]>.arrow {
  inset-inline-startcalc((0.5rem + 1px) * -1);
}
...
.bs-popover-auto[x-placement^="right"]>.arrow::before {
	border-inline-end-color: ${colors.borderPrimary};
}

.bs-popover-left>.arrow::before,
.bs-popover-auto[x-placement^="left"]>.arrow::before {
	border-inline-start-color: ${colors.borderPrimary};
}
...
.RichEditor-editor .RichEditor-blockquote {
  border-inline-start: 5px solid ${colors.borderDarker};
  color: ${colors.colorCoreGray};
  font-style: italic;
  padding: 10px 20px;
}
  ...
  *,:after,:before{
  ...
  .tiptap {
    ...
    blockquote {
      ...
      border-inline-start: 2px solid #0d0d0d1a;
    }
  ...
  .simple-inputs > div {
   ...
   .product-sidebar-filter-container {
    padding: 10px 0px; 
    & > div {
      margin-inline-start	: 16px;
      margin-inline-end: 16px;
     background-color: #1F97FF30;
  ...
  div[role="option"]:active,  div[role="option"]:selected {
