...
const StageFormContainer = styled.div`
  width: 100%;
  & input {
    background-color: ${colors.colorWhite};
  }
...
const Actions = styledTS<{ isSmall?: boolean }>(styled.div)`
  ...
  align-items: center;
  padding: 0 ${rtl(`${dimensions.coreSpacing}px`, `${dimensions.unitSpacing}px`)} ${dimensions.unitSpacing}px;
  ...
  > div {
    margin-inline-start	: ${rtl(`${dimensions.unitSpacing}px`, '0')};
    margin-inline-end: ${rtl('0', `${dimensions.unitSpacing}px`)};
    position: relative;
  }
...
const PopoverButton = styled.div`
  ...
  > i {
    margin-inline-start	: ${rtl('3px', '0')};
    margin-inline-end: ${rtl('0', '-4px')};
...
const PopoverHeader = styled.h3`
  ...
  padding: 10px ${rtl('20px', '10px')} 10px ${rtl('10px', '20px')};
  background: ${colors.colorWhite};
  font-size: 13px;
  text-transform: capitalize;
  border-radius: ${rtl('4px 4px 0 0', '4px 4px 0 0')};
  margin: 0;
  font-weight: 600;
...
const TipContent = styled.div`
  ...
  padding: ${rtl('4px 7px', '4px 7px')} !important;
...
const FullContent = styledTS<{
  ...
  display: flex;
  min-height: 100%;
  justify-content: ${(props) => (props.$center ? 'center' : rtl('flex-start', 'flex-end'))};
...
const BoxRoot = styledTS<{ $selected?: boolean }>(styled.div)`
  ...
  margin-inline-end: ${rtl(`${dimensions.coreSpacing}px`, '0')};
  margin-inline-start	: ${rtl('0', `${dimensions.coreSpacing}px`)};
  margin-bottom: ${dimensions.coreSpacing}px;
  border-radius: ${dimensions.unitSpacing / 2 - 1}px;
  transition: all 0.25s ease;
  border: 1px ${(props) => (props.$selected ? 'solid' : 'dashed')}
    ${(props) => (props.$selected ? colors.colorSecondary : 'rgba(0, 0, 0, 0.12)')};
...
const InfoTitle = styled.span`
  font-weight: 500;
  margin-bottom: 5px;
  margin-inline-end: ${rtl('10px', '0')};
  margin-inline-start	: ${rtl('0', '10px')};
`;

const InfoWrapper = styled.div`
  padding: 20px ${rtl('20px', '20px')} 30px ${rtl('20px', '20px')};
  display: flex;
...
const FormColumn = styled.div`
  flex: 1;
  padding-inline-end: ${rtl('40px', '0')};
  padding-inline-start: ${rtl('0', '40px')};
...
const Title = styledTS<{ capitalize?: boolean }>(styled.div)`
  ...
  > span {
    font-size: 75%;
    color: #666;
    margin-inline-start	: ${rtl('10px', '0')};
    margin-inline-end: ${rtl('0', '10px')};
    margin-top: 2px;
  }
`;
...
const LinkButton = styledTS<{ bgColor?: boolean }>(styled.a)`
  background-color: ${(props) => (props.bgColor ? '#fff' : 'transparent')};
  width: ${(props) => (props.bgColor ? 'fit-content' : '100%')};
  border-radius: ${(props) => (props.bgColor ? '6px' : '0px')};
  padding: ${(props) => (props.bgColor ? '5px' : '0px')};
  cursor: pointer;

  &:hover {
    text-decoration: ${(props) => (props.bgColor ? 'underline' : 'auto')};
  }
`;
...
const CustomerName = styled(FlexCenter)`
  ...
  time {
    padding-inline-start: ${rtl('5px', '0')};
    padding-inline-end: ${rtl('0', '5px')};
    color: ${colors.colorCoreGray};
    font-size: 12px;
  }
`;
...
const TextWrapper = styled.div`
  ...
  img {
    ...
    border-radius: 4px;
    margin-inline-start	: ${rtl('-20px', '0')};
    margin-inline-end: ${rtl('0', '-20px')};
  }
`;

const CenterContent = styled.div`
  text-align: ${rtl('center', 'center')};
  margin-top: 10px;
`;
...
const DropIcon = styledTS<{ $isOpen: boolean }>(styled.span)`
  ...
  &:after {
    ...
    float: ${rtl('right', 'left')};
    transition: all ease 0.3s;
    margin-inline-start	: ${rtl(`${dimensions.unitSpacing - 2}px`, '0')};
    margin-inline-end: ${rtl('0', `${dimensions.unitSpacing - 2}px`)};
...
const ScrollWrapper = styledTS<{ calcHeight?: string }>(styled.div)`
  ...
  height: ${(props) =>
    props.calcHeight
      ...
      : 'calc(100vh - 280px)'};
  overflow: auto;
  padding: 5px ${rtl('10px 0 20px', '20px 0 10px')};
  margin-inline-start	: ${rtl('-20px', '-10px')};
  margin-inline-end: ${rtl('-10px', '-20px')};
  margin-top: -5px;
`;
...
const Loader = styledTS<{
  ...
  margin-inline-end: ${(props) => rtl(props.marginRight || '0', '0')};
...
const DialogContent = styled.div`
  ...
  .dialog-description {
    padding: ${rtl('20px 30px 30px', '20px 30px 30px')};
    margin: 0;
  }
`;
...
const MenuDivider = styled.div`
  ...
  margin-inline-start	: ${rtl('0', 'auto')};
  margin-inline-end: ${rtl('auto', '0')};
`;
