import { AlertItem } from "@octobots/ui/src/utils/Alert/Alert";
import { CSSTransition } from "react-transition-group";
import Icon from "@octobots/ui/src/components/Icon";
import React from "react";
import { __ } from "../../utils/core";
import { dimensions } from "@octobots/ui/src/styles";
import styled from "styled-components";

const OldBrowserWarning = styled(AlertItem)`
  position: fixed;
  inset-inline-start: ${dimensions.headerSpacing}%;
      ...
      return (
        ...
        >
          <OldBrowserWarning type="error">
            <b>
              {__("Please upgrade your browser to use our platfrom!")}
              <Icon icon="cancel" size={10} onClick={this.closeAlert} />
            </b>
            <div>
              {__(
                "Unfortunately, You are running on a browser that may not be fully compatible with octobots"
              )}{" "}
