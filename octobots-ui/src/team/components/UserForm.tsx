...
import { IUser, IUserDetails, IUserLinks } from "@octobots/ui/src/auth/types";
import { __, getConstantFromStore } from "@octobots/ui/src/utils";
...
import UserCommonInfos from "@octobots/ui-settings/src/common/components/UserCommonInfos";
...
class UserForm extends React.Component<Props, State> {
  constructor(props: Props) {
    ...
    const defaultAvatar = "/images/avatar-colored.jpeg";
