import { InfoWrapper, Links } from '@octobots/ui/src/styles/main';
import { Name, NameContainer } from './styles';

import { AvatarWrapper } from '@octobots/ui/src/auth/styles';
...
import { renderUserFullName } from '@octobots/ui/src/utils';
