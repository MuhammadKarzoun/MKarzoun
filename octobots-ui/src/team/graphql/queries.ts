import channelQueries from '@octobots/ui-settings/src/channels/graphql/queries';
...
const fieldsGroups = `
  query fieldsGroups($contentType: String!, $isDefinedByOctobots: Boolean, $config: JSON) {
    fieldsGroups(contentType: $contentType, isDefinedByOctobots: $isDefinedByOctobots, config: $config) {
      name
      ${genericFields}
      isMultiple
      parentId
