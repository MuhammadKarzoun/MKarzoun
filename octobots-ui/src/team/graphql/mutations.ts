...
const usersSetAvailability = `
  mutation usersSetAvailability($_id: String!, $availability: String!) {
    usersSetAvailability(_id: $_id, availability: $availability) {
      _id
    }
  }
`;
