...
const PreviewTitle = styled.div`
  ...
  border-start-start-radius: ${dimensions.unitSpacing}px;
  border-start-end-radius: ${dimensions.unitSpacing}px;
...
const BodyContent = styled.div`
  span {
    &:after {
      inset-inline-start: ${dimensions.unitSpacing - 1}px;
    }
  }
...
const Embedded = styled.div`
  ...
  inset-inline-start: ${dimensions.unitSpacing / 2}%;
  width: 70%;
  background: ${colors.bgLight};
