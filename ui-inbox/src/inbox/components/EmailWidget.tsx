...
import CommonPortal from "@octobots/ui/src/components/CommonPortal";
...
import { getVersion, isEnabled } from "@octobots/ui/src/utils/core";
...
const Widget: React.FC<Props> = (props) => {
  const messengerDiv = document.getElementById("octobots-messenger-container");
