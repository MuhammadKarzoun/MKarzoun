import { IEmail } from '@octobots/ui-inbox/src/inbox/types';
...
export const generatePreviousContents = msgs => {
  ...
  msgs.forEach((msg, index) => {
    ...
    content += `
      <div style="margin-inline-start:${marginSpace}px;border-inline-start: 1px solid #ddd;padding-inline-start: 1ex;">
