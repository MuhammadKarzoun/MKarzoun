...
import { CenterContent, ModalFooter } from '@octobots/ui/src/styles/main';
import { Column, Columns } from '@octobots/ui/src/styles/chooser';
...
import { FlexBetween, Title } from '@octobots/ui-settings/src/styles';
    ...
    return (
      <div>
        ...
        <FlexBetween style={{ justifyContent: 'flex-end' }}>
          ...
          <Button btnStyle="warning" icon="check-circle" onClick={this.save}>
            Save
          </Button>
        </FlexBetween>
        </ModalFooter>
