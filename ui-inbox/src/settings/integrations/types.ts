...
import { IForm } from '@octobots/ui-forms/src/forms/types';
import { IProductCategory } from '@octobots/ui-products/src/types';
...
export type IntegrationTypesTiktok = 'tiktok';
